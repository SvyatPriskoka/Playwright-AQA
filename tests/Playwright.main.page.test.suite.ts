...
test.describe('Main page tests', () => {
  test('Check visability of the navigation elements (Header)', async ({ page }) => {
  ...
  test('Check names of the navigation elements (Header)', async ({ page }) => {
    await page.goto('https://playwright.dev/');
  ...
  test('Check names of the href atributes of the navigation elements (Header)', async ({
    page,
  }) => {
    await page.goto('https://playwright.dev/');
  ...
  test('Check the Light/Dark mode switcher', async ({ page }) => {
    await page.goto('https://playwright.dev/');
  ...
  test('Check the page header name', async ({ page }) => {
    await page.goto('https://playwright.dev/');
  ...
  test('Check the Get started element', async ({ page }) => {
    await page.goto('https://playwright.dev/');
...
test('Check names of the href atributes of the navigation elements (Header)', async ({ page }) => {
  await page.goto('https://playwright.dev/');
